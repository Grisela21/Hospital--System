...
Public Class MonthlyReports
    Private Sub MonthlyReports_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim sql As String = "SELECT MONTH(date) as month , COUNT(*) AS count FROM RESERVETION where YEAR(date) = '" + yearI.Text + "' GROUP BY MONTH(date)"
