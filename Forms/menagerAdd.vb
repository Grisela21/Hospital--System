...
Public Class menagerAdd
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If String.IsNullOrEmpty(role.Text) = True Then
            MessageBox.Show("Role is required!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        Else
            rolec = role.SelectedItem.ToString()
     ...
     VALUES
           ...
           ,'" + salt + "'
            ...
            Catch ex As SqlException When ex.ErrorCode = -2146232060
                MsgBox("This email has already an account.")
                Exit Sub
            End Try
